...
export const register = async (
  ...
  if (!insertInfo.acknowledged || !insertInfo.insertedId) {
    throw 'There was an error adding the user';
  }
...
export const login = async (userId, password) => {
  ...
  if(!ucheck){
    ...
    let loggedin = {firstName: ucheck.firstName, lastName: ucheck.lastName, userId: ucheck.userId, age: ucheck.age, gender: ucheck.gender, email: ucheck.email, signupDate: ucheck.signupDate, lastLogin: ucheck.lastLogin, reviews: ucheck.reviews, favorites: ucheck.favorites}
    return loggedin;
  }
};
